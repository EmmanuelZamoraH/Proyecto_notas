...
class edit_task : Fragment() {
    ...
    private fun scheduleNotification(id:Int){
        ...
        val message = "¡Prueba recordatorio!"
    ...
    private fun showAlert(time: Long, title: String, message: String) {
        ...
        AlertDialog.Builder(this@edit_task.requireContext()).setTitle("Recordatorio").setMessage("Title: "+ title +"\nMessage"+ message + "\nAt: " + dateFormat.format(date) + " " + timeFormat.format(date)).setPositiveButton("Aceptar"){_,_->}.show()
    }
